...
namespace aspnetcore8.Migrations
{
    ...
    [Migration("20231008163709_SampleTPH")]
    partial class SampleTPH
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aspnetcore8.Models.PersonTPH", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AllPersonModel", (string)null);
            ...
            modelBuilder.Entity("aspnetcore8.Models.StudentTPH", b =>
                {
                    b.HasBaseType("aspnetcore8.Models.PersonTPH");

                    b.Property<string>("StudentCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasDiscriminator().HasValue("StudentTPH");
                });

            modelBuilder.Entity("aspnetcore8.Models.TeacherTPH", b =>
                {
                    b.HasBaseType("aspnetcore8.Models.PersonTPH");
                    ...
                    b.HasDiscriminator().HasValue("TeacherTPH");
                });
